...
const styles = StyleSheet.create({
    ...
    username: {marginTop:20,borderWidth: 1, color:'#000000',borderRadius: 12, borderColor: 'lightgrey', padding: 15, fontSize: 16, backgroundColor: '#FFFFFF' },
    calView: { marginVertical:20,flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 15, alignItems: 'center', borderWidth: 1, borderRadius: 12, borderColor: 'lightgrey', backgroundColor: '#FFFFFF' },
    ...
    email: { fontSize: 16, },
    verify: { color: '#EE28A9' },
    updateButton: {marginVertical:20, marginBottom: 20, padding: 16, backgroundColor: '#51a6f5', alignItems: 'center', justifyContent: 'center', borderRadius: 12, },
